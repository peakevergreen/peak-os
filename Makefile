...
KERNEL_COMMON_SRCS := \
	...
	kernel/gui/browser_isolation.c \
...
$(eval $(call HOST_TEST_RULE,tls,tests/host/test_tls.c tests/host/tls_host_stubs.c \
	kernel/net/tls_util.c kernel/net/tls_trust.c kernel/net/tls_clienthello.c \
...
$(eval $(call HOST_TEST_RULE,hitbox_scale,tests/host/test_hitbox_scale.c,$(HOST_CFLAGS)))
...
$(eval $(call HOST_TEST_RULE,cli_grep,tests/host/test_cli_grep.c,$(HOST_CFLAGS)))
$(eval $(call HOST_TEST_RULE,cli_find,tests/host/test_cli_find.c,$(HOST_CFLAGS)))
$(eval $(call HOST_TEST_RULE,cli_sortflags,tests/host/test_cli_sortflags.c,$(HOST_CFLAGS)))
$(eval $(call HOST_TEST_RULE,cli_filemagic,tests/host/test_cli_filemagic.c,$(HOST_CFLAGS)))
$(eval $(call HOST_TEST_RULE,cli_date,tests/host/test_cli_date.c,$(HOST_CFLAGS)))
...
$(eval $(call HOST_TEST_RULE,cli_zip,tests/host/test_cli_zip.c,$(HOST_CFLAGS)))
...
$(eval $(call HOST_TEST_RULE,http2_hpack,tests/host/test_http2_hpack.c kernel/net/hpack.c,\
	$(HOST_CFLAGS) -DPEAK_HOST_TEST $(HOST_TEST_INC_KERNEL)))
$(eval $(call HOST_TEST_RULE,keyboard_repeat,tests/host/test_keyboard_repeat.c kernel/keyboard.c,\
	$(HOST_CFLAGS) -DPEAK_HOST_TEST $(HOST_TEST_INC_KERNEL)))
$(eval $(call HOST_TEST_RULE,browser_js,tests/host/test_browser_js.c tests/host/js_host_stubs.c \
	tests/host/browser_js_host_stubs.c kernel/gui/browser_js.c kernel/gui/dom_core.c \
	kernel/gui/browser_isolation.c \
	kernel/js/js_core.c kernel/js/js_compile.c kernel/js/js_lex.c \
	kernel/js/js_codegen.c kernel/js/js_parse.c kernel/js/js_vm.c,\
	$(HOST_CFLAGS_REDECL) -DPEAK_HOST_TEST $(HOST_TEST_INC_KERNEL) -Ikernel/js -Ikernel/gui))
