...
## CI automation (Wave 7 / Pass 158)

- [ ] `PEAK_SKIP_ISO=1 PEAK_SKIP_HOST_TESTS=0 ./scripts/smoke-cli.sh` passes Wave 7 Pass 139–157 marker blocks
- [ ] Host tests job (`make test-host`) green on main; `fuzz-parser-smoke.sh` included in `fuzz-elf-smoke.sh`
