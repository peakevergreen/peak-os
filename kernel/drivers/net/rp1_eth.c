 ...
 * Staged stub: PCIe BAR map + GEM datapath not implemented. Never claims ready.
 * Platform must not install until NETDEV_READY is reachable. */
...
static int rp1_ready(void) { return 0; }
