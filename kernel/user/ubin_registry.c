...
extern int ufile_main(int argc, char **argv);
...
extern int ushuf_main(int argc, char **argv);
extern int ucksum_main(int argc, char **argv);
extern int uxxd_main(int argc, char **argv);
extern int ufmt_main(int argc, char **argv);
extern int ucolumn_main(int argc, char **argv);
extern int uexpand_main(int argc, char **argv);
extern int uunexpand_main(int argc, char **argv);
...
extern int udnsflush_main(int argc, char **argv);
