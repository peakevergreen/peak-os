...
#define CTX_ACT_NPAD_APPLY_PATCH (CTX_ACT_APP_BASE + 26)
#define CTX_ACT_NPAD_APPROVE     (CTX_ACT_APP_BASE + 27)
#define CTX_ACT_NPAD_DENY        (CTX_ACT_APP_BASE + 28)
...
#define CTX_ACT_TERM_CLEAR_SB    (CTX_ACT_APP_BASE + 6)
...
#define CTX_ACT_BROWSER_DOWNLOAD   (CTX_ACT_APP_BASE + 23)
#define CTX_ACT_BROWSER_BM_RM_BASE (CTX_ACT_APP_BASE + 40)
...
extern int notify_hist_open;
extern int clipboard_picker_open;
