...
/* Peak OS freestanding adaptation: use Peak types instead of libc headers. */
...
#else
typedef void *FStar_IO_fd_read, *FStar_IO_fd_write;
#endif
...
#else
/* exit_code already typedef'd above for freestanding */
