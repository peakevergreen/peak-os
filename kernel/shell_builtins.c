...
static const struct help_entry help_table[] = {
    ...
    { "file", "file", "sniff file type (ELF/PPM/BMP/PEAKZIP1/PEAKGZ1/text)" },
    { "cat", "text", "print file" },
    { "head", "text", "first N lines" },
    { "tail", "text", "last N lines" },
    { "wc", "text", "line/word/byte count (-l -w -c)" },
    { "grep", "text", "substring search (-i -n -v -r)" },
    { "diff", "text", "line diff (-/+)" },
    { "sort", "text", "sort lines (-r -n -u)" },
    { "uniq", "text", "drop adjacent dup lines (-c)" },
